...
//            return false;
     ...
     * @return 用户点击了是或否
     */
    public static void closePane_confirmDialog(Stage stage) {
//        按钮部分可以使用预设的也可以像这样自己 new 一个
        Alert _alert = new Alert(Alert.AlertType.CONFIRMATION, "是否关闭程序", new ButtonType("取消", ButtonBar.ButtonData.NO),
                new ButtonType("确定", ButtonBar.ButtonData.YES));
//        设置窗口的标题
        _alert.setTitle("操作提示");
        _alert.setHeaderText("确认信息");
